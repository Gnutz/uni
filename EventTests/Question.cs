...
namespace TimerTest.Model
{
    public class Question
    {
        ...
        public event EventHandler<double> QuestionsPointCalculated;
        ...
        public void CalculateScore(Option option)
        {
            _PointScore = _IScore.CalculateScore(option._IsRight);
            QuestionsPointCalculated?.Invoke(this, _PointScore);
        }
    }
